...
- Fixed single-song playback after playlist enqueue by retaining the tapped song when Paging temporarily exposes an empty list and reading Media3 current-item and queue state atomically.
